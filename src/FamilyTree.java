...
public class FamilyTree {
	...
	public static void main(String[] args) {
		...
		dad = new FamilyTree(true, "Sambi", null, null, null, null, null);

		son1 = new FamilyTree(true, "jay", dad, null, null, null, null);
		son2 = new FamilyTree(true, "bha", dad, null, null, null, null);
